...
std::array<float, 3> Pmax_with_GausFit(const std::pair<float, unsigned int> Pmax, unsigned int maxIndex, int samples_fit);
std::array<float, 3> Pmax_for_samples(const std::pair<float, unsigned int> Pmax, unsigned int maxIndex, int samples_fit);
std::pair<float, unsigned int> Find_Negative_Signal_Maximum(bool confineSearchRegion,float searchRange[2]);
std::array<float, 3> Negative_Pmax_with_GausFit(const std::pair<float, unsigned int> NegPmax, unsigned int maxIndex, int samples_fit);
...
float Area_NC(const std::pair<float,unsigned int> pmax_holder, int t_beforeSignal, int t_afterSignal, float rms);
float Area_NC_pos(const std::pair<float,unsigned int> pmax_holder, int t_beforeSignal, int t_afterSignal, float rms);
