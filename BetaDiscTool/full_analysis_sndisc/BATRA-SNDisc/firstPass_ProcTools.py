...
def hist_tree_file_basics(tree,file,var,index,nBins,xUpper,biasVal,cut_cond,ch):
  var_dict = {"tmax":"t_{max} / 10 ns" , "pmax":"p_max / mV" , "negpmax":"-p_max / mV", "risetime":"Rise time / ns", "area_new":"Area / pWb" , "rms":"RMS / mV"}
  thisHist = root.TH1F("CH "+str(ch)+" "+biasVal, var+";"+var_dict[var]+";Events", nBins, 0, xUpper)
  if (var == "pmax"):
